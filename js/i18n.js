...
const I18N = {
  fr: {
    ...
    bank: 'Banque',
    shop: 'Boutique',
    shopTitle: 'Boutique des skins',
    shopDesc: 'Gagne 1 point toutes les 10 bonnes réponses, achète des skins ici.',
    skinFree: 'Gratuit',
    skinOwn: 'Possédé',
    skinEquip: 'Équiper',
    skinEquipped: 'Équipé',
    skinBuy: 'Acheter',
    skinTooPoor: 'Pas assez de points',
    home: 'Accueil',
  ...
  en: {
    ...
    shop: 'Shop',
    shopTitle: 'Skin shop',
    shopDesc: 'Earn 1 point every 10 correct answers. Spend them here.',
    skinFree: 'Free',
    skinOwn: 'Owned',
    skinEquip: 'Equip',
    skinEquipped: 'Equipped',
    skinBuy: 'Buy',
    skinTooPoor: 'Not enough points',
    home: 'Home',
